        ...
        <div className="info">
          <p>
            ...
            <InfoModal
              ...
              content="Loominate is a place for coworkers of the same organization. We group colleagues into the same private space (eg. acme.loominate.app) based on the work email used during sign-up (@acme.com). All users go through the same verification process.
